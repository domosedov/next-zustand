...
const Home: FC = () => {
  ...
  return (
    <div className='bg-red-100 sm:bg-red-300 tablet:bg-red-500 laptop:bg-red-700 container max-w-screen-laptop'>
      <h1>Home Page</h1>
        ...
        <div className='flex-1'>
          ...
          <div className='flex space-x-2 mt-4'>
            <div className='w-1/2 md:line-clamp-2'>
              Далеко-далеко за словесными горами в стране гласных и согласных
              живут рыбные тексты. Реторический свой семь буквоград но текст
